...
return [
    ...
    NotificationType::$APP_APPLICATION_NOREF => ':candidate is interested for the :position position',
    NotificationType::$WEB_APPLICATION_NOREF => ':candidate is interested for the :position position',
