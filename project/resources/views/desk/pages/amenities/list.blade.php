        ...
        <div class="box">
            ...
            <div class="box-body">
                ...
                <div id="admins_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
                    <div class="row">
                        <div class="col-sm-12">
                            <table class="table table-striped table-hover dt-responsive" cellspacing="0" width="100%" id="amenities-table">
                                <thead>
                                <tr>
                                    <th>Id</th>
                                    <th>Name</th>
...
@section('runnable')
    ...
    <script>
        $( document ).ready(function() {
            var tbl_el = $('#amenities-table');
            var table = tbl_el.DataTable({
                processing: true,
                serverSide: true,
                ajax: 'datatables/amenities',
                columnDefs: [ {
                    "targets": -1,
                    "data": null,
            ...
            tbl_el.on( 'click', 'a', function () {
                ...
                switch (ident){
                    case "show":
                        window.location.href="amenities/"+data['id'];
                        break;
                    case "update":
                        window.location.href="amenities/"+data['id'];
                        break;
