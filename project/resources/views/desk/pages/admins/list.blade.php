        ...
        <div class="box">
            ...
            <div class="box-body">
                ...
                <div id="admins_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
                    <div class="row">
                        <div class="col-sm-12">
                            <table class="table table-striped table-hover dt-responsive" cellspacing="0" width="100%" id="admins-table">
                                <thead>
                                <tr>
                                    <th>Id</th>
                                    <th>Name</th>
    ...
    <script>
        $( document ).ready(function() {
            ...
            $("#post").on('keyup', function () {
                var currentColumn = $("#operator").val();
                var val = $.fn.dataTable.util.escapeRegex($(this).val());
                table.columns([currentColumn]).search(val ? val : '', true, false).draw();
            });
            ...
            tbl_el.on( 'click', 'a', function () {
                ...
                switch (ident){
                    case "show":
                                 window.location.href="{{ url('admin') }}"+"/"+data['id'];
                                 break;
                    case "update":
                                  window.location.href="{{ url('admin') }}"+"/"+data['id'];
                                  break;
