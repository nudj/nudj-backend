    ...
    <section class="content">
        ...
        <div class="box">
            <div class="box-header with-border">
                <h3 class="box-title">List of Destinations</h3>
            </div>
            <div class="box-body">
                ...
                <div id="admins_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
                    <div class="row">
                        <div class="col-sm-12">
                            <table class="table table-striped table-hover dt-responsive" cellspacing="0" width="100%" id="destinations-table">
                                <thead>
                                <tr>
                                    <th>Id</th>
                                    <th>Name</th>
...
@section('runnable')
    ...
    <script>
        $( document ).ready(function() {
            var tbl_el = $('#destinations-table');
            var table = tbl_el.DataTable({
                processing: true,
                serverSide: true,
                ajax: 'datatables/destinations',
                columnDefs: [ {
                    "targets": -1,
                    "data": null,
                    ...
                    },
                    {
                        ...
                        "mRender": function ( data, type, full ) {
                            if(data && data >0){
                                return '<span class="label label-success">Top Pick</span>';
                            }
                            return "";
                        }
                    }
            ...
            tbl_el.on( 'click', 'a', function () {
                ...
                switch (ident){
                    case "show":
                        window.location.href="destinations/"+data['id'];
                        break;
                    case "update":
                        window.location.href="destinations/"+data['id'];
                        break;
